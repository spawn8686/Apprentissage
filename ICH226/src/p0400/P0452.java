...
/**
1.    Objectifs
	     Optimiser votre Robot pour qu'il puisse battre Wall

2.    Procédure
	     Le Robot précédent est un bon Robot mais il n'arrive presque jamais à toucher Wall.
	     Ajouter une constante à votre Robot pour qu'il décale son angle de tire
	     Faire combattre votre Robot contre Wall et trouver l'angle de décalage optimal pour
		toucher le plus souvent Wall

3.    Commentaires
	     Il est possible de réaliser un combat en 100 manches à vitesse max pour tester 
*/
...
public class P0452 extends AdvancedRobot 
{
	...
	private final int DELTA_FOR_WALLS = 13;
	...
	public void run() 
	{
		...
		while (true) 
		{
			...
			//Canon
			if(Math.abs(getGunTurnRemaining()) < 0.5 && getGunHeat() == 0)
			{
				setFire(10);
			}
	...
	public void onScannedRobot(ScannedRobotEvent event) 
	{
		...
		setTurnRadarRight(angleRadar + DELTA_FOR_WALLS);
