...
/**
 2.    Procédure
	     A l'initialisation du robot
		o   Activer la fonction d'ajustement automatique du canon par rapport au déplacement
			de votre robot
	     Lors de la détection d'un ennemi
		o   Tourner le canon de l'angle absolu jusqu'à l'ennemi – l'angle actuel du canon
		o   Tirer à une puissance de 1
3.    Commentaires
	     Vous aurez besoin des méthodes suivantes
		o   setTurnGunRight() ou setTurnGunRightRadians()
		o   setFire()
		o   setAdjustGunForRobotTurn()
		o   getGunHeading() ou getGunHeadingRadians()
	     Tester votre robot contre
		o   Target
		o   Ramfire
		o   Wall
	     Parfois le canon fait presque un tour complet à droite alors qu'il serait plus simple de
			faire un petit mouvement à gauche
		o   Utiliser les méthodes statiques de la classe Utils (de l'api Robocode)
			-   normalRelativeAngle() ou normalRelativeAngleDegrees()  
*/
...
public class P0440 extends AdvancedRobot {
