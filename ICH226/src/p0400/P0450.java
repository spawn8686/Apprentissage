...
/**
1.    Objectifs
	     Optimiser l'utilisation du canon en utilisant des actions non-bloquantes

2.    Procédure
	     Lors de la détection d'un ennemi
		o   Utiliser une des méthodes suivantes pour faire tourner le canon
			-   setTurnGunRight() ou setTurnGunRightRadians()
	     A chaque round
		o   Si le canon a fini de tourner et que la chaleur du canon est égale à 0
			-   tirer
		o   Passer au round suivant

3.    Commentaires
	     Pour calculer précisément l'angle minimal de rotation du canon, vous devrez utiliser une
		des méthodes statiques suivantes de la classe Utils :
...
public class P0450 extends AdvancedRobot 
{
