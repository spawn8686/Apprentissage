...
public class Conditions 
{
	...
	public static void main(String[] args) 
	{
		...
		//%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
		/*
		 * Création d'une variable int et affectation du valeur aléatoire
		 * création d'un test conditionnel, afin de déterminer si la variable et "positif, nul, négative"
		 * */
		int i = 0;
		if (i<0) 
		{
		...
		/*
		 * Même exercice que précédent, mais simplifié avec la condition else if
		 * */
		if (i<0) 
			System.out.println("La valeur est négative!");
		else if (i>0)
		...
		/*
		 * Test conditionnel grace à la méthode switch
		 * nous nous baserons sur une notation sur 20
		 * 0 = à revoir
		 * 10 = les base sont acquise mais à perfectionner
		 * 20 = le sujet est maîtrisé
		 * défaut = valeur quelconque
		 * */
		int l = 20;
		switch (l) 
		{
		case 0:
			...
			break;
		case 10:
			System.out.println("à perfectionner");
			break;
		case 20:
		...
		/*
		 * Le switch peut également tester les objets de type String
		 * Exemple
		 * */
		String str = "Bonjour";
		switch (str) 
		 ...
		 * si l'opération (x < y) est true, "?" renvoie y, sinon x
		 * */
		int x = 10, y = 20;
		int max = (x < y) ? y : x;
	}
